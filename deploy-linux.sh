...
echo "🐳 IMDb Movie Explorer - Linux Docker Deployment"
echo "==============================================="
...
if curl -f --max-time 10 http://localhost:8080/api/movies/health >/dev/null 2>&1; then
...
echo
echo "💡 Pro tip: Use 'docker-compose -f docker-compose.full.yml logs -f' to monitor logs"
